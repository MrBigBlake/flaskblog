      ...
      <div class="g-brd-around g-brd-gray-light-v4 g-pa-20 g-mb-40">
        <div class="row">
          <div class="col-sm-3 g-mb-40 g-mb-0--lg">
            <!-- User Image -->
            <div class="g-mb-20">
              <img v-if="user._links.avatar" class="img-fluid w-100" v-bind:src="user._links.avatar"
          ...
          <div class="col-sm-9">
            ...
            <ul class="list-inline g-font-weight-300">
              ...
              <li v-if="user.email" class="list-inline-item g-mr-20">
                ...
                class="g-color-main g-color-primary--hover" v-bind:href="'mailto:' + user.email">{{ user.email }}</a>
              </li>
            </ul>
            <!-- End User Info -->
